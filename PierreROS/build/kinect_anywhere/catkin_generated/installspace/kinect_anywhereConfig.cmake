...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kinect_anywhere' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/baxter/Desktop/PierreROS/install/${idir}'.  Ask the maintainer 'baxterpc <baxterpc@todo.todo>' to fix it.")
    endif()
