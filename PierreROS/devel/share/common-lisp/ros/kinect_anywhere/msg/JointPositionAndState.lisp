...
(cl:defmethod cl:initialize-instance :after ((m <JointPositionAndState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointPositionAndState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kinect_anywhere-msg:<JointPositionAndState> is deprecated: use kinect_anywhere-msg:JointPositionAndState instead.")))

(cl:ensure-generic-function 'trackingState-val :lambda-list '(m))
(cl:defmethod trackingState-val ((m <JointPositionAndState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinect_anywhere-msg:trackingState-val is deprecated.  Use kinect_anywhere-msg:trackingState instead.")
  (trackingState m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <JointPositionAndState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinect_anywhere-msg:position-val is deprecated.  Use kinect_anywhere-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'jointType-val :lambda-list '(m))
(cl:defmethod jointType-val ((m <JointPositionAndState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinect_anywhere-msg:jointType-val is deprecated.  Use kinect_anywhere-msg:jointType instead.")
  (jointType m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointPositionAndState>)))
  ...
  "kinect_anywhere/JointPositionAndState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointPositionAndState)))
  "Returns string type for a message object of type 'JointPositionAndState"
  "kinect_anywhere/JointPositionAndState")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<JointPositionAndState>)))
  ...
  "410ba2ac822815f4f20008df55046069")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'JointPositionAndState)))
  "Returns md5sum for a message object of type 'JointPositionAndState"
  "410ba2ac822815f4f20008df55046069")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<JointPositionAndState>)))
  ...
  (cl:format cl:nil "int32 trackingState~%geometry_msgs/Point position~%int32 jointType~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'JointPositionAndState)))
  "Returns full string definition for message of type 'JointPositionAndState"
  (cl:format cl:nil "int32 trackingState~%geometry_msgs/Point position~%int32 jointType~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
