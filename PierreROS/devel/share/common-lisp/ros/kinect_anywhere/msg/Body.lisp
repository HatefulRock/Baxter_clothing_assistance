...
(cl:defclass <Body> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (jointPositions
    ...
    :type (cl:vector kinect_anywhere-msg:JointPositionAndState)
   :initform (cl:make-array 0 :element-type 'kinect_anywhere-msg:JointPositionAndState :initial-element (cl:make-instance 'kinect_anywhere-msg:JointPositionAndState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Body>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Body)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kinect_anywhere-msg:<Body> is deprecated: use kinect_anywhere-msg:Body instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Body>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinect_anywhere-msg:header-val is deprecated.  Use kinect_anywhere-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'trackingId-val :lambda-list '(m))
(cl:defmethod trackingId-val ((m <Body>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinect_anywhere-msg:trackingId-val is deprecated.  Use kinect_anywhere-msg:trackingId instead.")
  (trackingId m))

(cl:ensure-generic-function 'jointPositions-val :lambda-list '(m))
(cl:defmethod jointPositions-val ((m <Body>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinect_anywhere-msg:jointPositions-val is deprecated.  Use kinect_anywhere-msg:jointPositions instead.")
  (jointPositions m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Body>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'jointPositions)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'kinect_anywhere-msg:JointPositionAndState))
