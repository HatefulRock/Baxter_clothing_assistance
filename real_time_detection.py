...
#save the video
fourcc = cv2.VideoWriter_fourcc(*'XVID')  # Specify the codec (here, XVID)
output_file = 'output.avi'  # Specify the output file name
frame_rate = 30.0  # Specify the frame rate (adjust as needed)
frame_size = (640, 480)  # Specify the frame size (adjust as needed)
