...
for num in tqdm(range(1, num_images+1)):
    ...
    json_name = '/Users/admin/Desktop/Yolo_transfer_learning/Baxter_clothing_assistance/data/images/validation/validation/annos/' + str(num).zfill(6)+'.json'
    image_name = '/Users/admin/Desktop/Yolo_transfer_learning/Baxter_clothing_assistance/data/images/validation/validation/image/' + str(num).zfill(6)+'.jpg'
